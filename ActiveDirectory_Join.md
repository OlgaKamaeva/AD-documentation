...
При добавлении машины в домен создается файл krb5.keytab, который хранит ключи для аутентификации машины в домене через Kerberos.  Он необходим для того, чтобы машина могла аутентифицироваться и взаимодействовать с доменом.
